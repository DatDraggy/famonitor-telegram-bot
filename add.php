...
- ' . $profileName;
    ...
    die('Added the following users to your monitor list:' . $added . ' You might receive a notification about a new journal about 8 minutes after adding a user. This issue will be fixed soon.');
  }
}

echo 'Added the following users to your monitor list:' . $added . ' You might receive a notification about a new journal about 8 minutes after adding a user. This issue will be fixed soon.';